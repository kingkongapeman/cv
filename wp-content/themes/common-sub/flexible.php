  ...
  <section>
                ...
                if( have_rows('content') ):
                    while ( have_rows('content') ) : the_row();
                        ...
                        <div class="container">  
                          <div class="row">
                            <div class="col-xs-12 <?php the_sub_field('intro'); ?> <?php the_sub_field('darken'); ?>"><?php the_sub_field('content'); ?></div>
                          </div>
                        </div>
                        </div>
                        <?
                        ...
                        <div class="flex-hero" style="background-image:url('<?php the_sub_field('image'); ?>');background-size:cover;background-position:50% 50%;">
